...
author: "Jonathan Gan <wg18>" # YOU SHOULD EDIT THIS
date: 2024-01-19
week: 2
categories: [Lab]
...
```{julia}
t_start = Dates.DateTime(2020, 03, 01, 0)
...
```{julia}
t_start = Dates.DateTime(1928, 01, 01, 0)
t_end = Dates.DateTime(2021, 12, 31, 23)
df_month = @subset(df, t_start .<= :datetime .<= t_end)
...
plot(
    ...
    xticks=1:12,
    title="Average Water levels by Month at Sewells Point, VA",
    xlabel="Month",
...
plot(
    ...
    df_climatology.lsl_avg;
    xticks=1:26:365,
    title="Average Water levels by Day of Year at Sewells Point, VA",
    xlabel="Day",
    ylabel="Average Water level",
    linewidth=3,
    label=false,
